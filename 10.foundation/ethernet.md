...
Ethernet II — доминирующая технология проводных локальных (LAN) и городских (MAN) сетей, осуществляющая **пакетную передачу кадров**.
...
|**Destination MAC**|6|—|
|**Source MAC**|6|—|
|**EtherType**, E-Type|2|Используемый L3-протокол|
